...
public class ExpressionSelectors
{
  ...
  )
  {
    ...
    final Expr.VectorBinding bindings = createVectorBindings(exprAnalysis, factory);
  ...
  private static Expr.VectorBinding createVectorBindings(
      Expr.BindingAnalysis bindingAnalysis,
      VectorColumnSelectorFactory vectorColumnSelectorFactory
  )
  {
    VectorSelectorVectorBinding binding = new VectorSelectorVectorBinding(vectorColumnSelectorFactory.getVectorSizeInspector());
    final List<String> columns = bindingAnalysis.getRequiredBindingsList();
    for (String columnName : columns) {
  ...
  static class VectorSelectorVectorBinding implements Expr.VectorBinding
  {
    ...
    public VectorSelectorVectorBinding(VectorSizeInspector sizeInspector)
    {
    ...
    public VectorSelectorVectorBinding addNumeric(String name, ExprType type, VectorValueSelector selector)
    {
    ...
    public VectorSelectorVectorBinding addObjectSelector(String name, ExprType type, VectorObjectSelector selector)
    {
