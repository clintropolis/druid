...
public class QueryContexts
{
  ...
  public static final String BROKER_POSSIBLY_PARALLEL_MERGE_KEY = "possiblyParallel";
  public static final String BROKER_PARALLELISM = "parallelism";
  ...
  public static final boolean DEFAULT_POSSIBLY_PARALLEL_MERGE = false;
  ...
  public static <T> boolean getPossiblyParallel(Query<T> query)
  {
    return parseBoolean(query, BROKER_POSSIBLY_PARALLEL_MERGE_KEY, DEFAULT_POSSIBLY_PARALLEL_MERGE);
  }
