    ...
    extends FormEncoder<TChunk, TChunkMetrics>
{
   ...
   * {@link io.druid.segment.data.CompressionStrategy} in use by {@link CompressedFormEncoder}
   *
   * @param buffer
   * @param values
   * @param numValues
   ...
   * {@link io.druid.segment.data.ShapeShiftingColumnSerializer} should not attempt compression since it can be very
