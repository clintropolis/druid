...
public class ColumnarDoublesSelectRowsBenchmark extends BaseColumnarDoublesFromGeneratorBenchmark
{
...
//    checkDoubleSanity(doubleData, all, rows);
  ...
  private void setupFromFile(String encoding) throws IOException
  {
    ...
    File compFile = new File(dir, encoding + "-" + type + "-" + distribution + "-" + rows + "-" + cardinality + ".bin");
  ...
  public static void main(String[] args) throws RunnerException
  {
    ...
    Options opt = new OptionsBuilder()
        .include(ColumnarDoublesSelectRowsBenchmark.class.getSimpleName())
        .addProfiler(EncodingSizeProfiler.class)
        .resultFormat(ResultFormatType.CSV)
        .result("column-doubles-select-speed.csv")
        .build();
