...
public class ColumnarIntsEncodeDataFromSegmentDataBenchmark extends BaseColumnarIntsFromSegmentsBenchmark
{
  @Setup
  ...
  public static void main(String[] args) throws RunnerException
  {
    ...
    Options opt = new OptionsBuilder()
        .include(ColumnarIntsEncodeDataFromSegmentDataBenchmark.class.getSimpleName())
