...
public class CachingClusteredClientBenchmark
{
  ...
  @Param({"parallel", "possiblyParallel", "serial"})
  ...
  public void setup()
  {
    ...
    switch (mergeCombineStyle) {
      case "possiblyParallel":
        parallelCombine = true;
        possiblyParallel = true;
        break;
      case "parallel":
        parallelCombine = true;
        possiblyParallel = false;
        break;
      case "serial":
      default:
    ...
    query = Druids.newTimeseriesQueryBuilder()
                  ...
                  .context(
                      ImmutableMap.of(
                          ...
                          QueryContexts.BROKER_POSSIBLY_PARALLEL_MERGE_KEY, possiblyParallel,
