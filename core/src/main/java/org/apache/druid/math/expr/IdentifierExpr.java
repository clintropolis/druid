    ...
    switch (inputTypes.getType(binding)) {
      case LONG:
        return new IdentifierVectorProcessor<long[]>(ExprType.LONG)
        {
          ...
          {
            return new LongVectorExprEval(bindings.getLongs(binding), bindings.getNulls(binding));
          }
        };
      case DOUBLE:
        return new IdentifierVectorProcessor<double[]>(ExprType.DOUBLE)
        {
          ...
          {
            return new DoubleVectorExprEval(bindings.getDoubles(binding), bindings.getNulls(binding));
          }
        };
      case STRING:
        return new IdentifierVectorProcessor<String[]>(ExprType.STRING)
        {
          ...
          {
            return new StringVectorExprEval(bindings.getObjects(binding));
          }
        };
      default:
