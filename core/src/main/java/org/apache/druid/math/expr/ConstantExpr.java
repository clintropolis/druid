  ...
  public <T> VectorExprProcessor<T> buildVectorized(VectorInputBindingTypes inputTypes)
  {
    ...
    return new VectorExprProcessor<T>()
    {
      private final VectorExprEval<T> eval =
          (VectorExprEval<T>) new LongVectorExprEval(constant, null);
      @Override
      public VectorExprEval<T> evalVector(VectorBinding bindings)
      {
        return eval;
      }
...
class DoubleExpr extends ConstantExpr
{
  ...
  public <T> VectorExprProcessor<T> buildVectorized(VectorInputBindingTypes inputTypes)
  {
    ...
    {
      private final VectorExprEval<T> eval =
          (VectorExprEval<T>) new DoubleVectorExprEval(constant, null);
      @Override
      public VectorExprEval<T> evalVector(VectorBinding bindings)
      {
        return eval;
...
class StringExpr extends ConstantExpr
{
  ...
  public <T> VectorExprProcessor<T> buildVectorized(VectorInputBindingTypes inputTypes)
  {
    ...
    {
      private final VectorExprEval<T> eval =
          (VectorExprEval<T>) new StringVectorExprEval(new String[inputTypes.getMaxVectorSize()]);
      @Override
      public VectorExprEval<T> evalVector(VectorBinding bindings)
      {
        return eval;
