...
public abstract class BivariateFunctionVectorProcessor<TOutput, TLeftInput, TRightInput> implements VectorExprProcessor<TOutput>
{
  ...
  @Override
  public final VectorExprEval<TOutput> evalVector(Expr.VectorBinding bindings)
  {
    ...
    final boolean[] leftNulls = lhs.nulls();
    final boolean[] rightNulls = rhs.nulls();
