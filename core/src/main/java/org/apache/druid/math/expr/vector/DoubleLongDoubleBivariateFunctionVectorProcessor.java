...
public abstract class DoubleLongDoubleBivariateFunctionVectorProcessor extends BivariateFunctionVectorProcessor<double[], long[], double[]>
{
  public DoubleLongDoubleBivariateFunctionVectorProcessor(
