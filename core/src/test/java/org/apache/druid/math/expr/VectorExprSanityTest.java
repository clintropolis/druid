...
public class VectorExprSanityTest extends InitializedNullHandlingTest
{
  ...
  static void testExpression(String expr, Map<String, ExprType> types)
  {
    ...
    NonnullPair<Expr.ObjectBinding[], Expr.VectorBinding> bindings;
  ...
  static NonnullPair<Expr.ObjectBinding[], Expr.VectorBinding> makeSequentialBinding(int vectorSize, Map<String, ExprType> types)
  {
  ...
  static NonnullPair<Expr.ObjectBinding[], Expr.VectorBinding> makeBindings(
      int vectorSize,
